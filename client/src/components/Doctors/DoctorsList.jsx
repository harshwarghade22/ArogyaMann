        ...
        <div className='w-full'>
            ...
            <div className='w-80% mx-20 mt-5 flex justify-around flex-wrap'>
                {doctors && doctors.map(doctor => (
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Level Handled: 
                            {doctor.level === 3 ? (
                    ...
                    <Link to={`/doctorsList/${doctor.id}/`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Contact
